...
<div className="w-full">
  {/* Top Section */}
  <div className="bg-[#171717] py-2 border-b border-[#333] px-4 sm:px-10">
    <p className="tracking-tight text-[8px] sm:text-[14px] font-semibold text-white text-left leading-[0.2rem] sm:leading-normal">Nigeria</p>
  </div>

  <div className="bg-[#171717] py-3 flex flex-row sm:justify-between px-4 sm:px-10 flex-wrap justify-center gap-4 text-xs">
    <div className="flex flex-row justify-around gap-4 sm:gap-5 text-center sm:text-left">
