    ...
    return(
        <div className="sticky mb-3">
            <div className="flex gap-4 justify-end items-center">
                <div className="tracking-tight text-[9x] sm:text-[14px] font-semibold text-white line leading-[0.2rem] sm:leading-normal">Gmail</div>
                <div className="tracking-tight text-[9x] sm:text-[14px] font-semibold text-white line leading-[0.2rem] sm:leading-normal">Images</div>
                <div>
